...
<div class="text-center">
  <h1><b>List Daftar Anggota Volly</b></h1>
  </div>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    <div class="card my-5 p-2">
        <div class="card-header">
            <a href="home.php?halaman=volly-add">
                <button class="mx-3 p-1 text-white btn rounded-0" style="font-size: 13px; background-color: #012970;" >
                    Tambah Anggota +
                </button>
            </a>
        </div>
                ...
                <tbody>
                    ...
                    <?php while ($data = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="volly_edit.php?id=<?php echo $data['ID'] ?>"><button class=" rounded-pil btn btn-warning bi bi-pencil-square p-1"></button></a>
                                <a href="volly_delete.php?id=<?php echo $data["ID"]?>"><button class=" btn btn-danger bi bi-trash3 p-1"></button></a>
                            </td>
                        </tr>
                        <?php endwhile ?>
                </tbody>
