...
include "koneksi.php";
$id = $_GET["id"];
$edit = $koneksi->query("SELECT * FROM basket WHERE ID='$id'");
...
<div class="text-center text-hitam bg bg-white m-4">
     <h3><b>Edit Anggota Basket</b> </h3>
</div>
<div class="col-md-8">
<form action="basket_update.php" method="post" class="m-4">
<div class="mb-3">
...
<div class="mb-3">
        <button type="submit" class="btn btn-warning" name="basket-update">Update</button>
