...
<div class="text-center">
  <h1><b>List Daftar Anggota Basket</b></h1>
  </div>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    ...
    <div class="card my-5 p-2">
        <div class="card-header ">
            <a href="home.php?halaman=basket-add">
                <button class="mx-3 p-1 text-white" style="font-size: 13px; background-color: #012970;" >
                    Tambah Anggota +
                </button>
            </a>
        </div>
        <div class="card-body ">
            <table class="border border table table-hover">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nama</th>
                ...
                <tbody>
                    ...
                    <?php while ($data = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="basket_edit.php?id=<?php echo $data['ID'] ?>"><button class=" btn btn-warning bi bi-pencil-square p-1"></button></a>
                                <a href="basket_delete.php?id=<?php echo $data["ID"]?>"><button class=" btn btn-danger bi bi-trash3 p-1"></button></a>
                            </td>
                        </tr>
                        <?php endwhile ?>
                </tbody>
