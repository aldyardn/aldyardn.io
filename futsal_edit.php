...
include "koneksi.php";
$id = $_GET["id"];
$edit = $koneksi->query("SELECT * FROM futsal WHERE ID='$id'");
...
<div class="row d-flex align-item-center justify-content-center" style="margin-top: 10%; margin-left :3%;">
     <div class="card " style="width: 50%; height:70%;">
          <div class="text-center text-hitam bg bg-white m-4">
               <h3><b>Edit Anggota Futsal</b> </h3>
          </div>
               <div class="col-md-8">
                    <form action="futsal_update.php" method="post" class ="m-4">
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                              <button type="submit" class="btn btn-warning" name="futsal-update">Update</button>
